...
describe("reduceTableData", () => {
  ...
  it("converts PriceData into RowData", () => {
    ...
    expect(result).toEqual([
      { open: 21.12, close: 22.54, high: 22.89, low: 20.11, volume: 1000, timestamp: "2023-01-01" },
      { open: 22.34, close: 23.67, high: 23.90, low: 21.22, volume: 2000, timestamp: "2023-01-02" },
      { open: 23.45, close: 24.78, high: 24.99, low: 22.33, volume: 3000, timestamp: "2023-01-03" },
    ]);
  });
